...
export const billingPlans = [
  {
    ...
    subtitle: "瑞幸咖啡价",
    highlight: false,
    features: ["对照翻译 10 篇/天", "沉浸全篇翻译 10 篇/天", "AI 论文综述 15 次/天", "研读解析与对话 30 次/天", "组会 PPT 制作 2 次/月"],
  },
  {
    id: "plus",
    billingCycle: "月度",
    ...
    subtitle: "热销推荐",
    highlight: true,
    features: ["对照翻译 20 篇/天", "沉浸全篇翻译 20 篇/天", "AI 论文综述 30 次/天", "研读解析与对话 60 次/天", "组会 PPT 制作 4 次/月", "论坛会员特效与标识"],
  },
  {
    id: "pro",
    billingCycle: "月度",
    ...
    subtitle: "极速进阶",
    highlight: false,
    features: ["对照翻译 50 篇/天", "沉浸全篇翻译 50 篇/天", "AI 论文综述 60 次/天", "研读解析与对话 120 次/天", "组会 PPT 制作 6 次/月", "论坛特效 + 每日1次置顶", "高峰期优先响应通道"],
  },
  {
    id: "team_plus",
    billingCycle: "月度",
    ...
    subtitle: "导师购买 (享9折)",
    highlight: false,
    features: ["导师按需购买统一分配", "每人每天对照/沉浸全篇各 20 篇", "每人每天 AI 综述 30 次 · 研读解析与对话 60 次", "每人每月组会 PPT 4 次", "全员享论坛特效与高峰优先"],
  },
  {
    id: "team_pro",
    billingCycle: "月度",
    ...
    subtitle: "实验室旗舰 (享9折)",
    highlight: false,
    features: ["导师按需购买统一分配", "每人每天对照/沉浸各 50 篇", "每人每天 AI 综述 60 次 · 研读解析与对话 120 次", "每人每月组会 PPT 6 次", "论坛特效 + 每日1次置顶 + 高峰优先"],
  },
];
