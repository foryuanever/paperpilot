...
.reading-entry-state h1 { margin: 18px 0 10px; color: #172033; font-size: 26px; }
.reading-entry-state p { max-width: 52ch; margin: 0; color: #5f6c80; font-size: 14px; line-height: 1.8; }
.reading-entry-actions { display: flex; flex-wrap: wrap; justify-content: center; gap: 10px; margin-top: 26px; }
.reading-empty-mark { width: 62px; height: 62px; display: grid; place-items: center; border-radius: 14px; color: #fff; background: #25344b; font: 700 25px/1 "Songti SC", serif; }
.reading-entry-pulse { width: 34px; height: 34px; border: 3px solid #dce3ed; border-top-color: #2563eb; border-radius: 50%; animation: reading-spin 700ms linear infinite; }
