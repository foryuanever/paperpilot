...
PAPERPILOT_SESSION_SECRET=${PAPERPILOT_SESSION_SECRET:-$(openssl rand -hex 32)}
PAPERPILOT_QQ_APP_ID=${PAPERPILOT_QQ_APP_ID:-}
PAPERPILOT_QQ_APP_SECRET=${PAPERPILOT_QQ_APP_SECRET:-}
PAPERPILOT_QQ_REDIRECT_URI=${PAPERPILOT_QQ_REDIRECT_URI:-https://papersolver.cn/api/auth/qq/callback}
PAPERPILOT_DEMO_SEED=${PAPERPILOT_DEMO_SEED:-false}
PAPERPILOT_WECHAT_APP_ID=${PAPERPILOT_WECHAT_APP_ID:-}
PAPERPILOT_WECHAT_APP_SECRET=${PAPERPILOT_WECHAT_APP_SECRET:-}
